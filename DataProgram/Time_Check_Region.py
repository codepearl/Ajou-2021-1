...
data1 = pd.read_csv('경기.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data2 = pd.read_csv('경남.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data3 = pd.read_csv('경북.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data4 = pd.read_csv('광주.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data5 = pd.read_csv('광주.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data6 = pd.read_csv('대전.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data7 = pd.read_csv('부산.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data8 = pd.read_csv('서울.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data9 = pd.read_csv('세종.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data10 = pd.read_csv('울산.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data11 = pd.read_csv('인천.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data12 = pd.read_csv('전남.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data13 = pd.read_csv('전북.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data14 = pd.read_csv('제주.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data15 = pd.read_csv('충남.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
...
data16 = pd.read_csv('전국통합_Header해결함.csv' , engine='python', encoding='cp949') #파일 읽기, csv 파일명 변경 필요 ^^ *중요*
